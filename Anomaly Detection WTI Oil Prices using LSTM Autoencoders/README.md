...
The production model is an **LSTM autoencoder**. It reconstructs 10-day windows of locally vol-normalized ΔClose (USD/bbl). A day is flagged when reconstruction MSE exceeds the 99th percentile of *quiet* 2010–2019 error. That threshold is frozen. 2020–present is out of sample.
...
| Folder | Contents |
| --- | --- |
| **[Production/](Production/)** | Training pipeline, scores and figures. This is the version to run and to review. |
